...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: themepath +'css/style.css', containers: 1400, grid: { gutters: 48 } },
			'wide':		{ range: '-1680', href: themepath +'css/style-wide.css', containers: 1200 },
			'normal':	{ range: '-1280', href: themepath +'css/style-normal.css', containers: '100%', grid: { gutters: 36 } },
			'narrow':	{ range: '-960', href: themepath +'css/style-narrow.css', grid: { gutters: 32 } },
			'narrower': { range: '-840', href: themepath +'css/style-narrower.css', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: themepath +'css/style-mobile.css', grid: { gutters: 16 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
